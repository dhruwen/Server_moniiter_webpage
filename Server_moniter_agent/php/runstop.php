...
<html lang="en">
  <head>
    <title>MonnitUI</title>
    <meta property="og:title" content="MonnitUI" />
      ...
      <div class="home-container">
        <div class="navbar-navbar-container">
          ...
          >
            <img
              alt="logo"
              src="public/playground_assets/untitled%20%5B1170%20%C3%97%20560%20px%5D%20%5B1%5D-200h.png"
              class="navbar-image"
            />
            <div class="navbar-nav">
              <nav class="navbar-nav1">
                <span class="navbar-text navbar-link"><span>Home</span></span>
                <span class="navbar-text1 navbar-link"><span>About</span></span>
              </nav>
            </div>
            ...
            <div data-role="MobileMenu" class="navigation-mobile-menu">
              ...
              <div class="navbar-social-media">
                <span class="navbar-text2"><span>Follow us</span></span>
            ...
            <button class="navbar-primary-btn1 button-primary button">
        ...
        <main class="home-main">
            ...
            <div class="home-max-width max-content-container">
              <form class="home-form">
                <div class="home-content-container">
                  <button
                    type="submit"
                    class="home-button button-primary button"
                  >
                   <a href="runandstop.php"> RUN</a>
                  </button>
                  <button
                    type="submit"
                    class="home-button1 button-primary button"
                  >
                      <a href="runstop.php"> STOP</a>
                  </button>
                </div>
              </form>
              <div class="home-image-container">
                <img
                  src="public/playground_assets/process-amico.svg"
                  alt="image"
                  class="home-image"
                />
              </div>
          ...
          <div class="home-copyright">
            <div class="home-max-width1 max-content-container">
              <span class="home-text">@ All Rights Reserved MONNIT</span>
            </div>
          </div>
        </main>
      </div>
